...
<script language="javascript" type="text/javascript">
		...
		switch(e.data.response){
			...
			case "Stop Recording":
				document.getElementById("recButton").innerHTML = e.data.response === "Start Recording" ? "Stop Recording" : "Start Recording";
				break;
			default:
				break;
		}
	...
	//Toggle Recording
	function recToggle(){
		document.getElementById("client-content").contentWindow.postMessage("recToggle","*");
	}

	function scrShareToggle(){
		document.getElementById("client-content").contentWindow.postMessage("srcShareToggle","*");
	}
